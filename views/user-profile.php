            ...
            <div class="mo_idp_table_layout mo-idp-center">
                ...
                <table border="1" style="background-color:#FFFFFF; 
                    ...
                    <tr>
                        ...
                        <td style="width:55%; padding: 10px;">'.esc_attr($email).' 
                        </td>
                    </tr>
                    <tr>
                        <td style="width:45%; padding: 10px;"><b>Customer ID</b></td>
                        <td style="width:55%; padding: 10px;">'.esc_attr($customerID).'</td>
                    </tr>
                    <tr>
                        <td style="width:45%; padding: 10px;"><b>API Key</b></td>
                        <td style="width:55%; padding: 10px;">'.esc_attr($apiKey).'</td>
                    </tr>
                    <tr>
                        <td style="width:45%; padding: 10px;"><b>Token Key</b></td>
                        <td style="width:55%; padding: 10px;">'.esc_attr($tokenKey).'</td>
                    </tr>
                </table>
            </div>
           </div>
