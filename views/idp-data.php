...
echo			        '</td>
                    ...
                    <tr>
                        ...
                        <td style="width:60%;  padding: 15px;">You can choose to sign your response in <a href="'.esc_url($idp_settings).'">Identity Provider</a></td>
                    </tr>
                    <tr>
                        <td style="width:40%; padding: 15px;"><b>Assertion Signed</b></td>
                        <td style="width:60%;  padding: 15px;">You can choose to sign your assertion in <a href="'.esc_url($idp_settings).'">Identity Provider</a></td>
                    </tr>
                </table>';
...
echo '
    ...
    if(certBtn){
        certBtn.onclick = function() {
            ...
            downloadmsg.style.display = "none";
            modal.style.display = "none";
            var ncurl = "' . addslashes(esc_url_raw($new_certificate_url)).'";
            console.log(ncurl);
            
            window.location.href="'. addslashes(esc_url($new_certificate_url)).'";
        }
    }
