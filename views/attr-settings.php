<?php
	...
	echo '      
                <form name="f" method="post" id="mo_name_idp_attr_settings">
                    ...
                    <input type="hidden" name="service_provider" value="'. (isset($sp) && !empty($sp) ? esc_attr($sp->id) : '') .'"/>
	...
	echo '	    <br/>
        ...
        echo 		                (empty($sp) ? 'disabled title="Disabled. Configure your Identity Provider"' : '') .' /> 
                            ...
                            <div id="idp_role_attr_name" class="mo_idp_help_desc" '. esc_attr($role_mapping_hidden) .'>
