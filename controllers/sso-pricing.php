<?php
    ...
    wp_enqueue_script( 'mo_idp_pricing_script', MSFSI_PRICING_JS_URL, array('jquery') );
	...
	$okgotit_url	= 'admin.php?page='.$freshdeskIntDetails->_menuSlug;
	...
	include MSFSI_DIR . 'views/pricing.php';